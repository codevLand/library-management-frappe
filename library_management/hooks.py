...
app_publisher = "Jomar Furiscal"
app_description = "Library Management System"
app_icon = "octicon octicon-file-directory"
app_color = "grey"
app_email = "jffuriscal@codedisruptors.com"
app_license = "MIT"
...
# app_include_js = "/assets/library_management/js/article.js"
...
web_include_css = "/assets/library_management/css/article.css"
web_include_js = "/assets/library_management/js/article.js"
...
scheduler_events = {
    # "all": [
    #     "library_management.scheduled_tasks.article_tasks.get_articles_all"
    # ],
	# "daily": [
    ...
    # "cron": {
    #     "0/1 * * * *": [
    #         "library_management.scheduled_tasks.article_tasks.get_articles_cron_minute"
    #     ]
    # }
}
